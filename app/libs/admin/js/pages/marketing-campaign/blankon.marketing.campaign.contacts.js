'use strict';
var BlankonMarketingCampaignContacts = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignContacts.handleDatatable();
            BlankonMarketingCampaignContacts.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-customer.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonMarketingCampaignContacts.handleActionViewDatatable();
                    BlankonMarketingCampaignContacts.handleActionEditDatatable();
                    BlankonMarketingCampaignContacts.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonMarketingCampaignContacts.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonMarketingCampaignContacts.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[8]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Postal Code :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[9]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Country :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[10]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Extra 1 :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[11]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Extra 2 :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[12]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Notes :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[13]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Status :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[14]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '</form>';
        ...
        handleActionEditDatatable: function () {
            ...
            $('#modal-edit-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<label class="col-sm-3 control-label">Address 1</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[5]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Address 2</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[6]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">City</label>' +
                    ...
                    '<label class="col-sm-3 control-label">State/Prov.</label>' +
                    '<div class="col-sm-9">' +
                    '<input class="form-control" type="text" value="' + $('<div/>').text(data[8]).html() + '">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Postal Code</label>' +
                    '<div class="col-sm-9">' +
                    '<input class="form-control" type="text" value="' + $('<div/>').text(data[9]).html() + '">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Country</label>' +
                    '<div class="col-sm-9">' +
                    '<input class="form-control" type="text" value="' + $('<div/>').text(data[10]).html() + '">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Extra 1</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[11]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Extra 2</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[12]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Notes</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[13]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Status</label>' +
                    '<div class="col-sm-9">' +
                    '<input class="form-control" type="text" value="' + $('<div/>').text(data[14]).html() + '">' +
                    '</div>' +
                    '</div>' +
                    '</form>';
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonMarketingCampaignContacts.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonMarketingCampaignContacts.init();