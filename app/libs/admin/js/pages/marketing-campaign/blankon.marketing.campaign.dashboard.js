var BlankonMarketingCampaignDashboard = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignDashboard.callModal();
            BlankonMarketingCampaignDashboard.counterOverview();
            BlankonMarketingCampaignDashboard.gritterNotification();
            ...
            BlankonMarketingCampaignDashboard.mapContinents();
            BlankonMarketingCampaignDashboard.chartShareOfSales();
            BlankonMarketingCampaignDashboard.chartTopProducts();
            BlankonMarketingCampaignDashboard.chartTopCustomers();
        ...
        // =========================================================================
        callModal: function () {
            $('#modal-dashboard-marketing-campaign').modal(
                {
                    show: true,
                    keyboard: false
                }
            );
            $('#modal-dashboard-marketing-campaign').on('hidden.bs.modal', function (e) {
                BlankonMarketingCampaignDashboard.sessionTimeout();
            })
        },
