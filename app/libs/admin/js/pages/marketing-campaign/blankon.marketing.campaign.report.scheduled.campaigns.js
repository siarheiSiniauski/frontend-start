var BlankonMarketingCampaignReportScheduledCampaigns = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignReportScheduledCampaigns.handleDatatable();
            BlankonMarketingCampaignReportScheduledCampaigns.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var tableID = $('#datatable-scheduled-campaigns');
            var table = $('#datatable-scheduled-campaigns').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/email-campaigns/datatable-scheduled-campaigns.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonMarketingCampaignReportScheduledCampaigns.handleActionViewDatatable();
                    BlankonMarketingCampaignReportScheduledCampaigns.handleActionEditDatatable();
                    BlankonMarketingCampaignReportScheduledCampaigns.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonMarketingCampaignReportScheduledCampaigns.handleNotificationDatatable('Table language '+$(this).data('title'));
                ...
                var tableID = $('#datatable-scheduled-campaigns');
                table = $('#datatable-scheduled-campaigns').DataTable( {
                    'language': {
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonMarketingCampaignReportScheduledCampaigns.handleNotificationDatatable($(this).text()+' Column');

            } );

            // Handle click on checkbox
            $('#datatable-scheduled-campaigns tbody').on('click', '.ckbox, input[type="checkbox"]', function(e){
            ...
            $('#datatable-scheduled-campaigns').on('click', 'tbody td', function(e){
            ...
            $('#datatable-scheduled-campaigns thead input[name="select_all"]').on('click', function(e){
                if(this.checked){
                    $('#datatable-scheduled-campaigns tbody input[type="checkbox"]:not(:checked)').trigger('click');
                } else {
                    $('#datatable-scheduled-campaigns tbody input[type="checkbox"]:checked').trigger('click');
                }
        ...
        handleActionViewDatatable: function () {
            $('#datatable-scheduled-campaigns').on('click', '.btn-view', function(){
                showModalDialog(this);
            });

            $('#modal-view-datatable-scheduled-campaigns').modal({ show: false });

            $('#modal-view-datatable-scheduled-campaigns').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-view-datatable-scheduled-campaigns').data('btn', elBtn);
                $('#modal-view-datatable-scheduled-campaigns').modal('show');
            }
        },
        ...
        handleActionEditDatatable: function () {
            $('#datatable-scheduled-campaigns').on('click', '.btn-edit', function(){
                showModalDialog(this);
            });

            $('#modal-edit-datatable-scheduled-campaigns').modal({ show: false });

            $('#modal-edit-datatable-scheduled-campaigns').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-edit-datatable-scheduled-campaigns').data('btn', elBtn);
                $('#modal-edit-datatable-scheduled-campaigns').modal('show');
            }
        },
        ...
        handleActionDeleteDatatable: function () {
            $('#datatable-scheduled-campaigns').on('click', '.btn-delete', function(){
                showModalDialog(this);
            });

            $('#modal-delete-datatable-scheduled-campaigns').modal({ show: false });

            $('#modal-delete-datatable-scheduled-campaigns').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-delete-datatable-scheduled-campaigns').data('btn', elBtn);
                $('#modal-delete-datatable-scheduled-campaigns').modal('show');
            }
        },
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                $('#datatable-scheduled-campaigns').addClass('table table-middle table-striped table-bordered table-condensed dataTable table-'+$(this).data('color'));

                // Call notifications
                BlankonMarketingCampaignReportScheduledCampaigns.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonMarketingCampaignReportScheduledCampaigns.init();
