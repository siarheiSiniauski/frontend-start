'use strict';
var BlankonMarketingCampaignQuotes = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignQuotes.handleDatatable();
            BlankonMarketingCampaignQuotes.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-quotes.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonMarketingCampaignQuotes.handleActionViewDatatable();
                    BlankonMarketingCampaignQuotes.handleActionEditDatatable();
                    BlankonMarketingCampaignQuotes.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonMarketingCampaignQuotes.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonMarketingCampaignQuotes.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<label class="col-sm-3 control-label">Quote Title :</label>' +
                    '<div class="col-sm-9">' +
                    ...
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static"><a href="mailto:'+data[4]+'" target="_blank">' + $('<div/>').text(data[4]).html() + '</a></p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    ...
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static"><span class="label label-'+quoteStatus+'">' + $('<div/>').text(data[6]).html() + '</span></p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
        ...
        handleActionEditDatatable: function () {
            ...
            $('#modal-edit-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<label class="col-sm-3 control-label">Company</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[2]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Customer</label>' +
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonMarketingCampaignQuotes.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonMarketingCampaignQuotes.init();