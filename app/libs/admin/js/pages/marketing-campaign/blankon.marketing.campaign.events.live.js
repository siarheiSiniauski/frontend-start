var BlankonMarketingCampaignEventsLive = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignEventsLive.handleDatatable();
            BlankonMarketingCampaignEventsLive.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var tableID = $('#datatable-live-events');
            var table = $('#datatable-live-events').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-live-events.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonMarketingCampaignEventsLive.handleActionViewDatatable();
                    BlankonMarketingCampaignEventsLive.handleActionEditDatatable();
                    BlankonMarketingCampaignEventsLive.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonMarketingCampaignEventsLive.handleNotificationDatatable('Table language '+$(this).data('title'));
                ...
                var tableID = $('#datatable-live-events');
                table = $('#datatable-live-events').DataTable( {
                    'language': {
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonMarketingCampaignEventsLive.handleNotificationDatatable($(this).text()+' Column');

            } );

            // Handle click on checkbox
            $('#datatable-live-events tbody').on('click', '.ckbox, input[type="checkbox"]', function(e){
            ...
            $('#datatable-live-events').on('click', 'tbody td', function(e){
            ...
            $('#datatable-live-events thead input[name="select_all"]').on('click', function(e){
                if(this.checked){
                    $('#datatable-live-events tbody input[type="checkbox"]:not(:checked)').trigger('click');
                } else {
                    $('#datatable-live-events tbody input[type="checkbox"]:checked').trigger('click');
                }
        ...
        handleActionViewDatatable: function () {
            $('#datatable-live-events').on('click', '.btn-view', function(){
                showModalDialog(this);
            });

            $('#modal-view-datatable-live-events').modal({ show: false });

            $('#modal-view-datatable-live-events').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-view-datatable-live-events').data('btn', elBtn);
                $('#modal-view-datatable-live-events').modal('show');
            }
        },
        ...
        handleActionEditDatatable: function () {
            $('#datatable-live-events').on('click', '.btn-edit', function(){
                showModalDialog(this);
            });

            $('#modal-edit-datatable-live-events').modal({ show: false });

            $('#modal-edit-datatable-live-events').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-edit-datatable-live-events').data('btn', elBtn);
                $('#modal-edit-datatable-live-events').modal('show');
            }
        },
        ...
        handleActionDeleteDatatable: function () {
            $('#datatable-live-events').on('click', '.btn-delete', function(){
                showModalDialog(this);
            });

            $('#modal-delete-datatable-live-events').modal({ show: false });

            $('#modal-delete-datatable-live-events').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-delete-datatable-live-events').data('btn', elBtn);
                $('#modal-delete-datatable-live-events').modal('show');
            }
        },
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                $('#datatable-live-events').addClass('table table-middle table-striped table-bordered table-condensed dataTable table-'+$(this).data('color'));

                // Call notifications
                BlankonMarketingCampaignEventsLive.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonMarketingCampaignEventsLive.init();