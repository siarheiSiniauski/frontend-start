'use strict';
var BlankonMarketingCampaignReportOrder = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignReportOrder.handleDatatable();
            BlankonMarketingCampaignReportOrder.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-order.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonMarketingCampaignReportOrder.handleActionViewDatatable();
                    BlankonMarketingCampaignReportOrder.handleActionEditDatatable();
                    BlankonMarketingCampaignReportOrder.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonMarketingCampaignReportOrder.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonMarketingCampaignReportOrder.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonMarketingCampaignReportOrder.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonMarketingCampaignReportOrder.init();