'use strict';
var BlankonMarketingCampaignReportProducts = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonMarketingCampaignReportProducts.handleDatatable();
            BlankonMarketingCampaignReportProducts.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-product.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonMarketingCampaignReportProducts.handleActionViewDatatable();
                    BlankonMarketingCampaignReportProducts.handleActionEditDatatable();
                    BlankonMarketingCampaignReportProducts.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonMarketingCampaignReportProducts.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonMarketingCampaignReportProducts.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionEditDatatable: function () {
            ...
            $('#modal-edit-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<label class="col-sm-3 control-label">Image product :</label>' +
                    '<div class="col-sm-9">' +
                    '<img src="'+data[1]+'" alt="..." class="display-inline"/>' +
                    ...
                    '<label class="col-sm-3 control-label">Product Name</label>' +
                    '<div class="col-sm-9">' +
                    '<textarea class="form-control">' + $('<div/>').text(data[3]).html() + '</textarea>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Status</label>' +
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonMarketingCampaignReportProducts.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonMarketingCampaignReportProducts.init();