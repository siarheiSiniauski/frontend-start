'use strict';
var BlankonEcommerceCustomerList = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceCustomerList.handleDatatable();
            BlankonEcommerceCustomerList.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonEcommerceCustomerList.handleActionViewDatatable();
                    BlankonEcommerceCustomerList.handleActionEditDatatable();
                    BlankonEcommerceCustomerList.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonEcommerceCustomerList.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonEcommerceCustomerList.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonEcommerceCustomerList.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonEcommerceCustomerList.init();